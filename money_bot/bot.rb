...
... и он ответит на такое сообщение, где есть _валюта и сумма_ — это очень удобно в общих чатах.

[Открытый код](https://github.com/m4rr/money_bot). Группа поддержки: @usdrubBotSupport
