...
`Я выиграл 10 000 баксов в конкурсе @durov!`

... и бот ответит на такое сообщение, где есть сумма и валюта.

Это очень удобно в переписке в общих чатах. Ничего не собирает и не хранит. [Открытый код.](https://github.com/m4rr/money_bot)
