...
Greet = """
Напишите боту: *Я выиграл 10 000 баксов в конкурсе Дурова!*, и бот ответит на такое сообщение, где есть _валюта и сумма_ — это удобно в чатах.

Бот бесплатный. [Открытый код](https://github.com/m4rr/money_bot). Группа поддержки: @usdrubBotSupport
