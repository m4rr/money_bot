...
Regex = /-?(#{Symbols})?(\d[ .,\d]*(?!\w\w))(mm(?!\w)|m(?!\w)|k(?!\w)|к|тыщ[а-я]{0,2}|тыс[а-я]{0,4}|млн|лям[а-я]{0,2}|миллион[а-я]{0,2}|млрд|миллиард[а-я]{0,2})? ?(#{Symbols}|dollar|доллар|бакс|евро|фунт|руб|бат|тенге|рингг?ит|канадск[а-я]{0,2} доллар|сгд|сингапурск[а-я]{0,2} доллар|хкд|гривн|грн|лари|злоты|zl|zł|рупи|[a-zA-Z]{3})? ?(to ([a-zA-Z]{3}))?/i
